...
public class PetService {
    ...
    public void listarPetsDoAbrigo() throws IOException, InterruptedException {
        ...
        HttpResponse<String> response = dispararRequest("/abrigos/" +idOuNome +"/pets", "GET" , null);
    ...
    public void importarPetsDoAbrigo() throws IOException, InterruptedException {
        ...
        while ((line = reader.readLine()) != null) {
            ...
            HttpResponse<String> response = dispararRequest("/abrigos/" + idOuNome + "/pets", "POST" , json);
